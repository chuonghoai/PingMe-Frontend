...
export const ChatRoomScreen = () => {
  ...
  const getTargetUserId = () => {
    return paramTargetUserId || actualTargetUserId;
  };
      ...
      >
        ...
        >
          ...
          {item.isTemporary && (
            <ActivityIndicator
              size="small"
              color={isMediaOnly ? COLORS.primary : COLORS.white}
              style={{ marginLeft: 6 }}
            />
          )}
    ...
    >
      ...
      {isRecordUIVisible ? (
          ...
          {audioUri ? (
            ...
            <>
              ...
              <TouchableOpacity onPress={playOrPauseAudio} style={{ marginHorizontal: 8 }}>
                {isPlaying ? <Pause size={28} color={COLORS.primary} /> : <Play size={28} color={COLORS.primary} />}
              </TouchableOpacity>
              ...
              >
                ...
                >
                  <View style={{ height: '100%', backgroundColor: COLORS.primary, width: playbackDurationMillis > 0 ? `${(playbackPosMillis / playbackDurationMillis) * 100}%` : '0%' }} />
                </View>
              ...
              <TouchableOpacity onPress={sendAudioMessage} style={{ backgroundColor: COLORS.primary, padding: 10, borderRadius: 24, marginLeft: 8 }}>
            ...
            <>
              ...
              >
                <Mic size={24} color={recording ? (COLORS.errorRed || '#FF3B30') : COLORS.primary} />
              </TouchableOpacity>
            </>
          )}
        </View>
        ...
        <View style={styles.inputContainer}>
          ...
          >
            <TouchableOpacity style={styles.mediaButton} onPress={handleCaptureMedia}>
              <Camera size={24} color={COLORS.iconGray} />
            </TouchableOpacity>
          ...
          <View style={styles.inputWrapper}>
            <TextInput
              ...
              multiline
            />
            <TouchableOpacity style={styles.stickerButton} onPress={() => setIsStickerPickerVisible(!isStickerPickerVisible)}>
              <Smile size={24} color={isStickerPickerVisible ? COLORS.primary : COLORS.iconGray} />
            </TouchableOpacity>
          </View>
  ...
  return (
    <View style={{ flexDirection: 'row', alignItems: 'center', width: 220, padding: 8, backgroundColor: isMe ? 'rgba(255,255,255,0.2)' : 'rgba(0,0,0,0.05)', borderRadius: 16 }}>
      <TouchableOpacity onPress={handlePlayPause}>
        {isPlaying ? <Square size={20} color={isMe ? COLORS.white : COLORS.primary} /> : <Play size={20} color={isMe ? COLORS.white : COLORS.primary} />}
      </TouchableOpacity>
      ...
      >
        <View style={{ width: '100%', height: 4, backgroundColor: 'rgba(150,150,150,0.5)', borderRadius: 2 }}>
          <View style={{ width: `${progress}%`, height: '100%', backgroundColor: isMe ? COLORS.white : COLORS.primary, borderRadius: 2 }} />
        </View>
      </View>
